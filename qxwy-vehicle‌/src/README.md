...
本项目是一个基于ROS 2的机器人自动驾驶系统，主要功能包括：
...
```bash
ros2 service call /speach_text autopilot_interfaces/srv/SpeechText "{text: '你好，欢迎使用小鱼机器人'}"
```
...
1. **Gazebo Harmonic**：需要手动点击"Run the simulation"按钮启动仿真
